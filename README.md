# Online-Bookstore-Sales-Inventory-Analysis-MySql-
Developed a relational database system for an online bookstore to manage books, customers, orders, and inventory. Performed sales and customer behavior analysis using SQL to generate business insights and support inventory management decisions.

# Key Features
Designed and implemented a normalized relational database schema with Books, Customers, and Orders tables using primary and foreign key relationships.
Imported and managed structured CSV datasets for efficient data storage and analysis.
-Created advanced SQL queries using:
 *JOINs
 *GROUP BY & HAVING
 *Subqueries
 *Aggregate Functions
 *Date-based Filtering
 *Generated analytical reports to evaluate:
 *Genre-wise revenue performance
 *Repeat customer behavior
 *Best-selling books
 *Monthly sales trends
 *Calculated remaining inventory after order fulfillment to support stock management.

# Key Insights
Identified top-performing genres contributing the highest revenue.
Analyzed customer purchase patterns to uncover repeat buyers.
Determined best-selling titles and monthly sales trends for business planning.
Provided inventory visibility by tracking stock levels after sales transactions.
# Tools & Technologies
MySQL
...
This project demonstrates how SQL-based analytics can transform transactional bookstore data into actionable insights for sales optimization, customer analysis, and inventory planning.



# SQL Querys performmed
